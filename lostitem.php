...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	if(empty($date_lost) || strtotime($date_lost) === false || strtotime($date_lost) > time()){
    ...
    if($category == 'person'){
        ...
        $extra[] = "Age: "            . $_POST['person_age'];
        $extra[] = "Last seen wearing: " . $_POST['person_wearing'];
    ...
    if(empty($error)){
        $sql = "INSERT INTO listings
			...
			VALUES
			('$user_id', '$title', '$description', '$category', '$location', '$date_lost', '$reward', '$image', 'lost', '$lat', '$lng')";
...
<?php if($success): ?>
    ...
    <div class="report-success">
        ...
        <p>Your lost item report has been published. The community will be notified and you'll receive a claim if someone finds it.</p>
        <div class="report-success-btns">
            <a href="browse.php" class="btn">Browse Listings</a>
            <a href="lostitem.php" class="btn btn-outline">Submit Another</a>
        </div>
    </div>
    ...
    <div class="report-page">
        ...
        <div class="report-left">
            ...
            <div class="report-header">
                <span class="report-type-tag lost-tag">🔴 Lost Item</span>
                <h1>Report a Lost Item</h1>
                <p>Fill in as much detail as possible to help the community identify and return your item.</p>
            </div>
            ...
            <form method="POST" class="report-form" enctype="multipart/form-data" id="reportForm">
                ...
                <div class="category-selector">
                    <p class="report-field-label">What did you lose?</p>
                ...
                <div class="report-section">
                    ...
                    <div class="report-field">
                        ...
                        <input type="text" name="title" placeholder="e.g. Black Samsung Galaxy S23, Golden Retriever named Max..." required>
                    </div>

                    <div class="report-field">
						<label>Location Lost <span class="required">*</span></label>
					...
					<div class="report-field" style="margin-top:16px;">
						...
						<input type="date" name="date_lost" max="<?php echo date('Y-m-d'); ?>" required>
					</div>
                ...
                <div id="fields-item" class="report-section cat-fields">
                    ...
                    <div class="report-field">
                        ...
                        <textarea name="description" placeholder="Color, brand, size, condition, any distinguishing marks..." required rows="4"></textarea>
                    </div>
                </div>
                ...
                <div id="fields-pet" class="report-section cat-fields" style="display:none;">
                    ...
                    <div class="report-row">
                        ...
                        <div class="report-field">
                            ...
                            <input type="text" name="pet_name" placeholder="e.g. Max, Mochi...">
                        </div>
                    </div>
                    <div class="report-row">
                        <div class="report-field">
                            <label>Breed</label>
                            <input type="text" name="pet_breed" placeholder="e.g. Golden Retriever, Persian...">
                        </div>
                        <div class="report-field">
                            <label>Color / Markings</label>
                            <input type="text" name="pet_color" placeholder="e.g. Golden with white patch...">
                        </div>
                    </div>
                    <div class="report-field">
                        <label>Additional Description <span class="required">*</span></label>
                        <textarea name="description" placeholder="Collar color, tags, microchipped, behavior, any distinguishing features..." required rows="4"></textarea>
                    </div>
                </div>
                ...
                <div id="fields-vehicle" class="report-section cat-fields" style="display:none;">
                    ...
                    <div class="report-field">
                        <label>Additional Description <span class="required">*</span></label>
                        <textarea name="description" placeholder="Make, model, year, condition, any stickers or modifications..." required rows="4"></textarea>
                    </div>
                </div>
                ...
                <div id="fields-person" class="report-section cat-fields" style="display:none;">
                    ...
                    <div class="report-row">
                        <div class="report-field">
                            ...
                            <input type="text" name="person_name" placeholder="Full name if known">
                        </div>
                        <div class="report-field">
                            <label>Age / Estimated Age</label>
                            <input type="number" name="person_age" placeholder="e.g. 65">
                        </div>
                    </div>
                    <div class="report-field">
                        <label>Last Seen Wearing</label>
                        <input type="text" name="person_wearing" placeholder="e.g. Blue shirt, black pants, white tudung...">
                    </div>
                    <div class="report-field">
                        <label>Distinguishing Features</label>
                        <input type="text" name="person_features" placeholder="e.g. Glasses, scar on left cheek, walks with limp...">
                    </div>
                    <div class="report-field">
                        <label>Additional Description <span class="required">*</span></label>
                        <textarea name="description" placeholder="Any other details that could help identify this person..." required rows="4"></textarea>
                    </div>
                </div>
                ...
                <div class="report-section">
                    ...
                    <div class="report-row">
                        <div class="report-field">
                            <label>Reward Offered (RM)</label>
                            <input type="number" name="reward" placeholder="Leave blank if not offering reward" min="0">
                        </div>
        ...
        <div class="report-right">
            ...
            <div class="report-tips">
                ...
                <ul>
                    ...
                    <li>Double-check the location — be precise</li>
                    <li>Mention the exact date it went missing</li>
                    <li>A reward increases the chance of recovery</li>
                </ul>
            </div>
            ...
            <div class="report-tips" style="margin-top:20px;">
                <h3>⚠️ Important</h3>
                <ul>
                    <li>Do not share sensitive personal info publicly</li>
                    <li>Arrange handovers in safe, public locations</li>
                    <li>Verify the claimant's identity before handing over</li>
                    <li>For missing persons, also contact the authorities</li>
                </ul>
            </div>
