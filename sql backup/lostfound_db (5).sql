...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2026 at 03:48 PM
...
(6, 111, 54, 'ni kipas aku oii awat hang rembat', 'collected', '2026-06-07 14:53:38', 1, 'cash', NULL),
(7, 112, 54, 'aku ada jumpa la dok jam kau', 'collected', '2026-06-07 17:59:47', 1, 'online', NULL),
(8, 113, 54, 'aku jumpa oi', 'collected', '2026-06-08 13:35:44', 1, 'online', 'cash');
...
(113, 2, 'Lost Asus V16', '', 'item', 'Jalan Ilmu 1/1, 40450 Shah Alam, Selangor, Malaysia', 'uploads/1780925645_0_9cf54f513d65a85cbbfd5a6fb70ab4547a4f6907e1e51b2cd1a4f2bda0a8e317.webp', 'lost', 1, 'removed', 'resolved', '2026-06-08 13:34:05', 0, '2026-05-28', '50', 3.06976520, 101.50368230, 0, NULL, '2026-06-15 15:34:57', 0, NULL, NULL),
(114, 54, 'Lost Vintage Zippo Lighter', '', 'item', 'Av. de Concha Espina, 1, Chamartín, 28036 Madrid, Spain', 'uploads/1781019556_0_ChopperLighter_Final_1.webp', 'lost', 1, 'active', 'active', '2026-06-09 15:39:16', 0, '2026-06-06', '100', 40.45301960, -3.68837480, 0, NULL, '2026-06-16 17:52:17', 0, NULL, NULL),
(115, 54, 'Lost Samsung Galaxy S24 Ultra', '', 'item', 'Gaza', 'uploads/1781021207_0_samsung-galaxy-s24-ultra-220053812-1x1.webp', 'lost', 1, 'active', 'active', '2026-06-09 16:06:47', 0, '2026-06-07', '100', 31.50169510, 34.46684450, 0, NULL, '2026-07-09 18:07:25', 0, NULL, NULL);
...
INSERT INTO `listing_images` (`id`, `listing_id`, `image`, `sort_order`) VALUES
(1, 113, 'uploads/1780925645_0_9cf54f513d65a85cbbfd5a6fb70ab4547a4f6907e1e51b2cd1a4f2bda0a8e317.webp', 0),
(2, 114, 'uploads/1781019556_0_ChopperLighter_Final_1.webp', 0),
(3, 115, 'uploads/1781021207_0_samsung-galaxy-s24-ultra-220053812-1x1.webp', 0);
...
(1, 2, 'claim', '📋 Walif Kee Ni submitted a claim on your listing: Lost Asus V16', 'incoming_claims.php', 1, '2026-06-08 13:35:44'),
(2, 54, 'collected', 'Your claim on \"Lost Asus V16\" has been Collected.', 'myclaims.php', 1, '2026-06-08 18:22:01'),
(3, 53, 'reward', '💳 Walif Kee Ni requested an online reward payment of RM10.00 for \"Lost Casio Watch\".', 'incoming_claims.php', 0, '2026-06-09 09:08:17'),
(4, 53, 'reward', '💰 Walif Kee Ni confirmed a cash reward arrangement for \"Lost Portable Fan\".', 'incoming_claims.php', 0, '2026-06-09 09:08:26');
...
CREATE TABLE `payments` (
  ...
  `claimant_amount` decimal(10,2) DEFAULT NULL,
  ...
  `tp_reference` varchar(100) DEFAULT NULL,
  `claim_id` int(11) DEFAULT NULL,
  `boost_days` int(11) DEFAULT 30,
  `created_at` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `payments` (`id`, `user_id`, `listing_id`, `type`, `amount`, `claimant_amount`, `method`, `status`, `reference`, `tp_reference`, `claim_id`, `boost_days`, `created_at`) VALUES
(1, 5, 19, 'boost', 5.00, NULL, 'online', 'paid', 'SIM-6A24523856606', NULL, NULL, 30, '2026-06-07 01:00:40'),
(2, 2, 113, 'boost', 5.49, NULL, 'online', 'paid', 'SIM-6A26C5013DCB7', NULL, NULL, 30, '2026-06-08 21:34:57'),
(3, 2, 113, 'reward', 50.00, NULL, 'online', 'paid', 'RWD-6A27080726923', NULL, NULL, 30, '2026-06-09 02:20:55'),
(4, 54, 112, 'reward', 10.00, NULL, 'online', 'paid', 'RWD-6A27D80189611', NULL, NULL, 30, '2026-06-09 17:08:17'),
(5, 54, 111, 'reward', 10.00, NULL, 'cash', 'pending', 'RWD-6A27D80A4598D', NULL, NULL, 30, '2026-06-09 17:08:26'),
(7, 54, 114, 'boost', 5.49, NULL, 'online', 'paid', 'BOOST-6A28369E677BC', 'TP2606092428529996', NULL, 7, '2026-06-09 23:51:58'),
(8, 54, 115, 'boost', 18.90, NULL, 'online', 'paid', 'BOOST-6A283A2A6D8FC', 'TP2606101130098448', NULL, 30, '2026-06-10 00:07:06');
